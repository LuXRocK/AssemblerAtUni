...
namespace EdgeDetectionApp
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtFilePath.Location = new Point((formWidth - txtFilePath.Width - 100) / 2, 20);
            ...
            lblImage.Location = new Point(txtFilePath.Left - lblImage.Width, 20);

            btnBrowse = new Button();
            btnBrowse.Text = "Przeglądaj...";
            btnBrowse.Size = new Size(90, 25);
            btnBrowse.Location = new Point(txtFilePath.Right + 10, txtFilePath.Top);
            btnBrowse.Click += BtnBrowse_Click;

            groupBoxDll = new GroupBox();
            groupBoxDll.Text = "Wybierz bibliotekę";
            groupBoxDll.Size = new Size(200, 80);
            groupBoxDll.Location = new Point((formWidth - groupBoxDll.Width) / 2, txtFilePath.Bottom + 20);
            ...
            pictureBoxResult.Size = new Size(540, 260);
            ...
            lblTime.Location = new Point((formWidth / 2)-(lblTime.Width / 2), formHeight - 20);

            threadOptions = new GroupBox();
            threadOptions.Text = "Wybierz ilość wątków: ";
            threadOptions.AutoSize = true;
            threadOptions.Location = new Point((Width / 2) + 105, 10);
        ...
        private void BtnStart_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtFilePath.Text) && System.IO.File.Exists(txtFilePath.Text))
            {
                try
                {
                    ...
                    int bufferSize = width * height; // 8bpp: 1 bajt na piksel
